...
static void esp_nn_aligned_s8_pad_with_value(const int8_t *src, int8_t *dst, const uint16_t input_wd,
                                             const uint16_t input_ht, const uint16_t channels, const int32_t pad_val,
                                             const uint16_t pad_wd, const uint16_t pad_ht) {
  /* memset with pad_val */
...
static void esp_nn_aligned_s8_pad_end_with_value(const int8_t *src, int8_t *dst, const uint16_t input_wd,
                                                 const uint16_t input_ht, const uint16_t channels,
                                                 const int32_t pad_val, const uint16_t pad_wd, const uint16_t pad_ht) {
  for (int i = 0; i < input_ht; i++) {
    for (int j = 0; j < input_wd * channels; j++) {
      *dst++ = *src++;
    }
 ...
 */
__NN_FORCE_INLINE__ void esp_nn_s8_to_s16_with_offset(const int8_t *src, int16_t *dst, const int size,
