...
const int8_t test_add_in1[] = {
    13,  26,  -26, 26,  -13, 13,  -13, 13,  -13, 13,  -13, 13,  -26, -51, -26, -51, -26, -39, -26, -39, -39, -39,
    -26, -51, -13, -13, -13, -13, -26, -13, -13, -13, -13, -13, 0,   -26, 0,   -13, 0,   -26, -13, -26, -26, -26,
    -26, -26, -26, -26, -13, -13, 0,   -26, -13, -26, -26, -26, 0,   0,   -26, -13, 13,  0,   26,  0,   13,  0,
    13,  0,   0,   0,   13,  0,   13,  26,  -26, 13,  -26, 13,  -13, 13,  -13, 13,  -13, 13,  -26, -26, -13, -26,
    -26, -26, -26, -26, -39, -26, -26, -26, -13, 0,   -13, 0,   -26, 0,   -13, 0,   -13, 0,   -13, -13, 0,   0,
    0,   -13, -13, -13, -26, -13, -26, -13, -13, -13, -13, 0,   0,   -13, -13, -13, -13, -13, 0,   0,   -13, 0,
    13,  13,  13,  0,   0,   0,   13,  13,  0,   0,   13,  13,  0,   26,  0,   13,  0,   13,  0,   13,  0,   13,
    0,   13,  0,   13,  0,   0,   0,   0,   0,   13,  0,   0,   0,   0,   13,  13,  0,   13,  0,   13,  0,   13,
    0,   13,  0,   13,  13,  13,  0,   13,  0,   13,  0,   13,  0,   13,  13,  13,  13,  13,  0,   13,  0,   13,
    0,   13,  13,  13,  13,  13,  13,  13,  13,  13,  0,   13,  13,  13,  13,  13,  13,  13,
};

const int8_t test_add_in2[] = {
    -128, -128, -103, -128, -77, -128, -52,  -128, -26,  -128, -1,  -128, -128, -103, -103, -103, -77, -103,
    -52,  -103, -26,  -103, -1,  -103, -128, -77,  -103, -77,  -77, -77,  -52,  -77,  -26,  -77,  -1,  -77,
    -128, -52,  -103, -52,  -77, -52,  -52,  -52,  -26,  -52,  -1,  -52,  -128, -26,  -103, -26,  -77, -26,
    -52,  -26,  -26,  -26,  -1,  -26,  -128, -1,   -103, -1,   -77, -1,   -52,  -1,   -26,  -1,   -1,  -1,
    -128, -128, -103, -128, -77, -128, -52,  -128, -26,  -128, -1,  -128, -128, -103, -103, -103, -77, -103,
    -52,  -103, -26,  -103, -1,  -103, -128, -77,  -103, -77,  -77, -77,  -52,  -77,  -26,  -77,  -1,  -77,
    -128, -52,  -103, -52,  -77, -52,  -52,  -52,  -26,  -52,  -1,  -52,  -128, -26,  -103, -26,  -77, -26,
    -52,  -26,  -26,  -26,  -1,  -26,  -128, -1,   -103, -1,   -77, -1,   -52,  -1,   -26,  -1,   -1,  -1,
...
void esp_nn_add_elementwise_s8_test() {
  ...
  for (int itr = 0; itr < 10; itr++) {
    ...
    if (input1_orig == NULL || input2_orig == NULL || out_c_orig == NULL || out_opt_orig == NULL) {
    ...
    /* C function */
    esp_nn_add_elementwise_s8_ansi(input1, input2, input1_offset, input2_offset, input1_mult, input2_mult, input1_shift,
                                   input2_shift, left_shift, out_data_c, output_offset, output_mult, output_shift,
    ...
    /* Optimized function */
    esp_nn_add_elementwise_s8(input1, input2, input1_offset, input2_offset, input1_mult, input2_mult, input1_shift,
                              input2_shift, left_shift, out_data_opt, output_offset, output_mult, output_shift,
                              activation_min, activation_max, size);
    if (itr == 0) {
      /* disable profiler */
      profile_opt_end();
...
void esp_nn_mul_elementwise_s8_test() {
  ...
  for (int itr = 0; itr < 10; itr++) {
    ...
    /* C function */
    esp_nn_mul_elementwise_s8_ansi(input1, input2, input1_offset, input2_offset, out_data_c, output_offset, output_mult,
    ...
    /* Optimized function */
    esp_nn_mul_elementwise_s8(input1, input2, input1_offset, input2_offset, out_data_opt, output_offset, output_mult,
                              output_shift, activation_min, activation_max, size);
