...
#define SC031GS_LED_STROBE_ENABLE_REG \
  0x3361  // When the camera is in exposure, this PAD LEDSTROBE will be high to drive the external LED.
...
static const struct sc031gs_regval sc031gs_200x200_init_regs[] = {
    ...
    {0x320c, 0x03},
    {0x320d, 0x6b},
    {0x320e, 0x01},  // default 120fps: {0x320e, 0x01},{0x320f, 0x40}, 58fps: {0x320e, 0x02},{0x320f, 0xab}; 30fps:
                     // {0x320e, 0x05}, {0x320f, 0x34}
    {0x320f, 0x40},
