...
#define FRAME_CTRL01 \
  0x4201  // Control Passed Frame Number When both ON and OFF number set to 0x00,frame control is in bypass mode
          // Bit[7:4]: Not used
          // Bit[3:0]: Frame ON number
#define FRAME_CTRL02 \
  0x4202  // Control Masked Frame Number When both ON and OFF number set to 0x00,frame control is in bypass mode
          // Bit[7:4]: Not used
          // BIT[3:0]: Frame OFF number

/* ISP top control registers */
#define PRE_ISP_TEST_SETTING_1 \
  0x3025  // Bit[7]: Test enable
          //         0: Test disable
          //         1: Color bar enable
          // Bit[6]: Rolling
          // Bit[5]: Transparent
...
#define AEC_PK_MANUAL \
  0x3201  // AEC Manual Mode Control
          // Bit[7:6]: Reserved
...
#define TIMING_TC_REG20 \
  0x3022  // Timing Control Register
...
#define CLOCK_POL_CONTROL \
  0x3024  // Bit[5]: PCLK polarity 0: active low
          //          1: active high
