...
class AllocationInfoBuilder {
 public:
  AllocationInfoBuilder(const Model *model, INonPersistentBufferAllocator *non_persistent_allocator)
  ...
  TfLiteStatus InitializeAllocationInfo(const int32_t *offline_offsets, SubgraphAllocations *allocations);
  ...
  TfLiteStatus MarkAllocationLifetimes(int subgraph_idx, internal::ScratchBufferRequest *scratch_buffer_request,
  ...
  TfLiteStatus MarkSubgraphLifetimesIfNecessary(const Operator *op,
