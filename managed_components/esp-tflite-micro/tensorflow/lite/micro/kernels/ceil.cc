...
TfLiteStatus CeilEval(TfLiteContext *context, TfLiteNode *node) {
  ...
  reference_ops::Ceil(tflite::micro::GetTensorShape(input), tflite::micro::GetTensorData<float>(input),
...
TFLMRegistration Register_CEIL() { return tflite::micro::RegisterOp(nullptr, CeilPrepare, CeilEval); }
