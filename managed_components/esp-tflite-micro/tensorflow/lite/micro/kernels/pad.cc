...
TfLiteStatus PadEval(TfLiteContext *context, TfLiteNode *node) {
  ...
  switch (input->type) {
    ...
    case kTfLiteInt16: {
      ...
      reference_ops::Pad(data->params, tflite::micro::GetTensorShape(input),
                         tflite::micro::GetTensorData<int16_t>(input), &pad_value,
    ...
    case kTfLiteInt32: {
      ...
      reference_ops::Pad(data->params, tflite::micro::GetTensorShape(input),
                         tflite::micro::GetTensorData<int32_t>(input), &pad_value,
...
TFLMRegistration Register_PAD() { return tflite::micro::RegisterOp(PadInit, PadPrepare, PadEval); }

// Also register Pad as PadV2.
TFLMRegistration Register_PADV2() { return tflite::micro::RegisterOp(PadInit, PadPrepare, PadEval); }
