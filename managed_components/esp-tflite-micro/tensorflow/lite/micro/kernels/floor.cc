...
TfLiteStatus FloorEval(TfLiteContext *context, TfLiteNode *node) {
  ...
  reference_ops::Floor(tflite::micro::GetTensorShape(input), tflite::micro::GetTensorData<float>(input),
...
TFLMRegistration Register_FLOOR() { return tflite::micro::RegisterOp(nullptr, nullptr, FloorEval); }
