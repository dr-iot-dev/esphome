...
TfLiteStatus Eval(TfLiteContext *context, TfLiteNode *node) {
  ...
  TF_LITE_ENSURE_OK(context, resources->Assign(input_id->data.i32[0], input_value));
  return kTfLiteOk;
}

}  // namespace.

TFLMRegistration Register_ASSIGN_VARIABLE() { return tflite::micro::RegisterOp(nullptr, Prepare, Eval); }
