...
class MicroContext {
 public:
  ...
  virtual TfLiteStatus RequestScratchBufferInArena(size_t bytes, int *buffer_idx) = 0;
  ...
  TfLiteTensor *AllocateTempIntermediateTensor(const TfLiteNode *node, int index);
...
inline TfLiteExternalContext *MicroContextGetExternalContext(TfLiteContext *context, TfLiteExternalContextType unused) {
