...
const TFLMRegistration *PackerOp::getRegistration() { return GetMutableRegistration(); }
...
void *PackerOp::Init(TfLiteContext *context, const char *buffer, size_t length) {
  freed_ = false;
  // Do nothing.
  return nullptr;
}
...
TfLiteStatus PackerOp::Prepare(TfLiteContext *context, TfLiteNode *node) { return kTfLiteOk; }
