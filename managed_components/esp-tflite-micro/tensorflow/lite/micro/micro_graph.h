...
class MicroGraph {
 public:
  ...
  virtual TfLiteEvalTensor *GetSubgraphInput(int subgraph_idx, int input_idx) = 0;
  ...
  virtual TfLiteEvalTensor *GetSubgraphOutput(int subgraph_idx, int output_idx) = 0;
