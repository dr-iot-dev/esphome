...
template<class T> struct SubImpl {
  template<class F>
  static void BroadcastInput1(const ArithmeticParams &params, const T *input1_data, const T *input2_data,
  ...
  template<class F>
  static void BroadcastInput2(const ArithmeticParams &params, const T *input1_data, const T *input2_data,
                              T *output_data, size_t size, F binary_func) {
    for (size_t c = 0; c < size; ++c) {
  ...
  template<class F>
  static void ElementWise(const ArithmeticParams &params, const T *input1_data, const T *input2_data, T *output_data,
...
template<> struct SubImpl<int32_t> {
  template<class F>
  static void BroadcastInput1(const ArithmeticParams &params, const int32_t *input1_data, const int32_t *input2_data,
                              int32_t *output_data, size_t size, F binary_func) {
    size_t c = 0;
  ...
  template<class F>
  static void BroadcastInput2(const ArithmeticParams &params, const int32_t *input1_data, const int32_t *input2_data,
                              int32_t *output_data, size_t size, F binary_func) {
    size_t c = 0;
    int32_t activation_min, activation_max;
    GetActivationParams(params, &activation_min, &activation_max);
  ...
  template<class F>
  static void ElementWise(const ArithmeticParams &params, const int32_t *input1_data, const int32_t *input2_data,
                          int32_t *output_data, size_t size, F binary_func) {
    size_t c = 0;
    int32_t activation_min, activation_max;
    GetActivationParams(params, &activation_min, &activation_max);
...
inline void BroadcastSubRecursiveDimensions(int dimension, const ArithmeticParams &params, const T *input1_data,
  ...
  if (dimension > 0) {
    for (size_t c = 0; c < compressed_output_shape[dimension]; ++c) {
      ...
      BroadcastSubRecursiveDimensions(dimension - 1, params, input1_data, input2_data, output_data, &input1_offset_c,
                                      &input2_offset_c, output_offset, compressed_input1_stride,
    ...
    if (input1_is_broadcast) {
      // input1 is broadcast.
      SubImpl<T>::BroadcastInput1(params, input1_data_ptr, input2_data_ptr, output_data_ptr,
      ...
      *input2_offset_p += compressed_output_shape[dimension];
      ...
      // input2 is broadcast.
      SubImpl<T>::BroadcastInput2(params, input1_data_ptr, input2_data_ptr, output_data_ptr,
                                  compressed_output_shape[dimension], binary_func);
      *input1_offset_p += compressed_output_shape[dimension];
    } else {
      // Add element-wise.
      SubImpl<T>::ElementWise(params, input1_data_ptr, input2_data_ptr, output_data_ptr,
                              compressed_output_shape[dimension], binary_func);
      *input1_offset_p += compressed_output_shape[dimension];
      *input2_offset_p += compressed_output_shape[dimension];
    }
...
template<typename T, typename F>
inline void BroadcastSubCommon(const ArithmeticParams &params, const RuntimeShape &input1_shape, const T *input1_data,
                               const RuntimeShape &input2_shape, const T *input2_data, const RuntimeShape &output_shape,
                               T *output_data, F binary_func) {
  ...
  BroadcastSubRecursiveDimensions(kMaxBroadcastDim - 1, params, input1_data, input2_data, output_data, &input1_offset,
...
template<typename T>
void BroadcastSubSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape, const T *input1_data,
                      const RuntimeShape &input2_shape, const T *input2_data, const RuntimeShape &output_shape,
                      T *output_data) {
  ruy::profiler::ScopeLabel label("BroadcastSubSlow/T");
  BroadcastSubCommon<T>(params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
...
inline void BroadcastSub16POTSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape,
  ...
  BroadcastSubCommon<int16_t>(
      ...
      [](int16_t input1_val, int16_t input2_val, const ArithmeticParams &params) {
        const int32_t scaled_input1_val = gemmlowp::RoundingDivideByPOT(input1_val, -params.input1_shift);
        const int32_t scaled_input2_val = gemmlowp::RoundingDivideByPOT(input2_val, -params.input2_shift);
...
template<typename T>
void BroadcastQuantSubSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape, const T *input1_data,
                           const RuntimeShape &input2_shape, const T *input2_data, const RuntimeShape &output_shape,
                           T *output_data) {
  ...
  BroadcastSubCommon<T>(
      params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
      [](T input1_val, T input2_val, const ArithmeticParams &params) {
        const int32_t shifted_input1_val = (params.input1_offset + input1_val) * (1 << params.left_shift);
        const int32_t shifted_input2_val = (params.input2_offset + input2_val) * (1 << params.left_shift);
        ...
        const int32_t raw_output =
            MultiplyByQuantizedMultiplierSmallerThanOneExp(raw_sub, params.output_multiplier, params.output_shift) +
...
template<typename T>
inline void SubElementwise(int size, const ArithmeticParams &params, const T *input1_data, const T *input2_data,
                           T *output_data) {
...
inline void Sub(const ArithmeticParams &params, const RuntimeShape &input1_shape, const uint8_t *input1_data,
...
inline void Sub(const ArithmeticParams &params, const RuntimeShape &input1_shape, const int8_t *input1_data,
...
inline void Sub(const ArithmeticParams &params, const RuntimeShape &input1_shape, const int16_t *input1_data,
...
template<typename T>
void Sub(const ArithmeticParams &params, const RuntimeShape &input1_shape, const T *input1_data,
         const RuntimeShape &input2_shape, const T *input2_data, const RuntimeShape &output_shape, T *output_data) {
  BroadcastSubCommon<T>(
      params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
      [](T input1_val, T input2_val, const ArithmeticParams &params) { return input1_val - input2_val; });
}

inline void SetActivationMinMax(const ArithmeticParams &params, int32_t *activation_min, int32_t *activation_max) {
  *activation_min = params.quantized_activation_min;
  *activation_max = params.quantized_activation_max;
}

inline void SetActivationMinMax(const ArithmeticParams &params, float *activation_min, float *activation_max) {
  *activation_min = params.float_activation_min;
  *activation_max = params.float_activation_max;
}

inline void SetActivationMinMax(const ArithmeticParams &params, int64_t *activation_min, int64_t *activation_max) {
  *activation_min = params.int64_activation_min;
  *activation_max = params.int64_activation_max;
}

template<typename T>
inline void SubWithActivation(const ArithmeticParams &params, const RuntimeShape &input1_shape, const T *input1_data,
                              const RuntimeShape &input2_shape, const T *input2_data, const RuntimeShape &output_shape,
                              T *output_data) {
