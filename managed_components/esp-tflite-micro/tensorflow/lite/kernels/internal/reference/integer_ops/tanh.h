...
inline void Tanh(int32_t input_zero_point, int32_t input_range_radius, int32_t input_multiplier, int32_t input_shift,
  ...
  for (int i = 0; i < flat_size; ++i) {
    ...
    if (input <= -input_range_radius) {
      ...
      const int32_t input_in_q4 = MultiplyByQuantizedMultiplier(input, input_multiplier, input_shift);
...
inline void Tanh(int32_t input_multiplier, int32_t input_left_shift, const RuntimeShape &input_shape,
