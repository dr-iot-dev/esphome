...
template<typename T>
void BroadcastInput1(int size, const ArithmeticParams &params, const T *input1_data, const T *input2_data,
...
template<typename T>
void BroadcastInput2(int size, const ArithmeticParams &params, const T *input1_data, const T *input2_data,
                     T *output_data, void (*check_arithmetic_params)(const ArithmeticParams &),
                     T (*binary_func)(T, T, const ArithmeticParams &)) {
  CheckArithmeticParams(params);
  for (int i = 0; i < size; ++i) {
...
// TODO: b/270589088 - move to a more appropriate file (b/270589088#comment2)
template<typename T>
void ElementWise(int size, const ArithmeticParams &params, const T *input1_data, const T *input2_data, T *output_data,
  ...
  if (dimension > 0) {
    for (size_t c = 0; c < compressed_output_shape[dimension]; ++c) {
      ...
      BroadcastAddRecursiveDimensions(params, dimension - 1, &input1_offset_c, &input2_offset_c, output_offset,
                                      ...
                                      input1_data, input2_data, output_data, check_arithmetic_params, binary_func);
    ...
    if (input1_is_broadcast) {
      // input1 is broadcast.
      BroadcastInput1<T>(compressed_output_shape[dimension], params, input1_data_ptr, input2_data_ptr, output_data_ptr,
                         check_arithmetic_params, binary_func);
      *input2_offset_p += compressed_output_shape[dimension];
    } else if (input2_is_broadcast) {
      // input2 is broadcast.
      BroadcastInput2<T>(compressed_output_shape[dimension], params, input1_data_ptr, input2_data_ptr, output_data_ptr,
                         check_arithmetic_params, binary_func);
      *input1_offset_p += compressed_output_shape[dimension];
    } else {
      // Add element-wise.
      ElementWise<T>(compressed_output_shape[dimension], params, input1_data_ptr, input2_data_ptr, output_data_ptr,
                     check_arithmetic_params, binary_func);
      *input1_offset_p += compressed_output_shape[dimension];
      *input2_offset_p += compressed_output_shape[dimension];
    }
...
// TODO: b/270589088 - move to a more appropriate file. (b/270589088#comment2)
template<typename T>
void BroadcastBinaryFunction6DSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape,
...
template<typename T>
void BroadcastBinaryFunction4DSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape,
                                   const T *input1_data, const RuntimeShape &input2_shape, const T *input2_data,
                                   const RuntimeShape &output_shape, T *output_data,
                                   void (*check_arithmetic_params)(const ArithmeticParams &),
                                   T (*binary_func)(T, T, const ArithmeticParams &)) {
  BroadcastBinaryFunction6DSlow(params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
                                check_arithmetic_params, binary_func);
}
...
inline void AddElementwise(int size, const ArithmeticParams &params, const int8_t *input1_data,
                           const int8_t *input2_data, int8_t *output_data) {
  ElementWise(size, params, input1_data, input2_data, output_data, CheckArithmeticParams, AddFunc);
}

inline void Add(const ArithmeticParams &params, const RuntimeShape &input1_shape, const int8_t *input1_data,
...
inline void BroadcastAdd6DSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape,
                               const int8_t *input1_data, const RuntimeShape &input2_shape, const int8_t *input2_data,
                               const RuntimeShape &output_shape, int8_t *output_data) {
  BroadcastBinaryFunction6DSlow(params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
                                CheckArithmeticParams, AddFunc);
}

inline void BroadcastAdd4DSlow(const ArithmeticParams &params, const RuntimeShape &input1_shape,
                               const int8_t *input1_data, const RuntimeShape &input2_shape, const int8_t *input2_data,
                               const RuntimeShape &output_shape, int8_t *output_data) {
  BroadcastBinaryFunction6DSlow(params, input1_shape, input1_data, input2_shape, input2_data, output_shape, output_data,
                                CheckArithmeticParams, AddFunc);
