...
RecognizeCommands::RecognizeCommands(int32_t average_window_duration_ms, float detection_threshold,
...
TfLiteStatus RecognizeCommands::ProcessLatestResults(const TfLiteTensor *latest_results, const int32_t current_time_ms,
