...
inline const BaseType (&EnumValuesBaseType())[20] {
  static const BaseType values[] = {None,  UType, Bool,   Byte,   UByte,  Short, UShort, Int,   UInt,     Long,
                                    ULong, Float, Double, String, Vector, Obj,   Union,  Array, Vector64, MaxBaseType};
  return values;
}
...
struct Type FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  reflection::BaseType element() const { return static_cast<reflection::BaseType>(GetField<int8_t>(VT_ELEMENT, 0)); }
  ...
  uint32_t element_size() const { return GetField<uint32_t>(VT_ELEMENT_SIZE, 0); }
...
struct TypeBuilder {
  ...
  void add_fixed_length(uint16_t fixed_length) { fbb_.AddElement<uint16_t>(Type::VT_FIXED_LENGTH, fixed_length, 0); }
  void add_base_size(uint32_t base_size) { fbb_.AddElement<uint32_t>(Type::VT_BASE_SIZE, base_size, 4); }
  void add_element_size(uint32_t element_size) { fbb_.AddElement<uint32_t>(Type::VT_ELEMENT_SIZE, element_size, 0); }
  explicit TypeBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct KeyValue FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const KeyValue *const o) const { return *key() < *o->key(); }
  int KeyCompareWithValue(const char *_key) const { return strcmp(key()->c_str(), _key); }
...
struct KeyValueBuilder {
  ...
  explicit KeyValueBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct EnumVal FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const EnumVal *const o) const { return value() < o->value(); }
  int KeyCompareWithValue(int64_t _value) const {
    return static_cast<int>(value() > _value) - static_cast<int>(value() < _value);
  }
  const reflection::Type *union_type() const { return GetPointer<const reflection::Type *>(VT_UNION_TYPE); }
...
struct EnumValBuilder {
  ...
  explicit EnumValBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct Enum FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *name() const { return GetPointer<const ::flatbuffers::String *>(VT_NAME); }
  bool KeyCompareLessThan(const Enum *const o) const { return *name() < *o->name(); }
  int KeyCompareWithValue(const char *_name) const { return strcmp(name()->c_str(), _name); }
  ...
  const reflection::Type *underlying_type() const { return GetPointer<const reflection::Type *>(VT_UNDERLYING_TYPE); }
  const ::flatbuffers::Vector<::flatbuffers::Offset<reflection::KeyValue>> *attributes() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<reflection::KeyValue>> *>(VT_ATTRIBUTES);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *documentation() const {
...
struct EnumBuilder {
  ...
  explicit EnumBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct Field FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *name() const { return GetPointer<const ::flatbuffers::String *>(VT_NAME); }
  bool KeyCompareLessThan(const Field *const o) const { return *name() < *o->name(); }
  int KeyCompareWithValue(const char *_name) const { return strcmp(name()->c_str(), _name); }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_NAME) && verifier.VerifyString(name()) &&
           ...
           VerifyField<int64_t>(verifier, VT_DEFAULT_INTEGER, 8) && VerifyField<double>(verifier, VT_DEFAULT_REAL, 8) &&
           VerifyField<uint8_t>(verifier, VT_DEPRECATED, 1) && VerifyField<uint8_t>(verifier, VT_REQUIRED, 1) &&
           VerifyField<uint8_t>(verifier, VT_KEY, 1) && VerifyOffset(verifier, VT_ATTRIBUTES) &&
           ...
           verifier.VerifyVectorOfStrings(documentation()) && VerifyField<uint8_t>(verifier, VT_OPTIONAL, 1) &&
           VerifyField<uint16_t>(verifier, VT_PADDING, 2) && VerifyField<uint8_t>(verifier, VT_OFFSET64, 1) &&
           verifier.EndTable();
  }
};
...
struct FieldBuilder {
  ...
  void add_type(::flatbuffers::Offset<reflection::Type> type) { fbb_.AddOffset(Field::VT_TYPE, type); }
  ...
  void add_optional(bool optional) { fbb_.AddElement<uint8_t>(Field::VT_OPTIONAL, static_cast<uint8_t>(optional), 0); }
  void add_padding(uint16_t padding) { fbb_.AddElement<uint16_t>(Field::VT_PADDING, padding, 0); }
  void add_offset64(bool offset64) { fbb_.AddElement<uint8_t>(Field::VT_OFFSET64, static_cast<uint8_t>(offset64), 0); }
...
inline ::flatbuffers::Offset<Field> CreateFieldDirect(
  ...
  return reflection::CreateField(_fbb, name__, type, id, offset, default_integer, default_real, deprecated, required,
                                 key, attributes__, documentation__, optional, padding, offset64);
}
...
struct Object FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *name() const { return GetPointer<const ::flatbuffers::String *>(VT_NAME); }
  bool KeyCompareLessThan(const Object *const o) const { return *name() < *o->name(); }
  int KeyCompareWithValue(const char *_name) const { return strcmp(name()->c_str(), _name); }
...
struct ObjectBuilder {
  ...
  explicit ObjectBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline ::flatbuffers::Offset<Object> CreateObjectDirect(
  ...
  auto documentation__ =
      documentation ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*documentation) : 0;
  auto declaration_file__ = declaration_file ? _fbb.CreateString(declaration_file) : 0;
  return reflection::CreateObject(_fbb, name__, fields__, is_struct, minalign, bytesize, attributes__, documentation__,
                                  declaration_file__);
}
...
struct RPCCall FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *name() const { return GetPointer<const ::flatbuffers::String *>(VT_NAME); }
  bool KeyCompareLessThan(const RPCCall *const o) const { return *name() < *o->name(); }
  int KeyCompareWithValue(const char *_name) const { return strcmp(name()->c_str(), _name); }
  const reflection::Object *request() const { return GetPointer<const reflection::Object *>(VT_REQUEST); }
  const reflection::Object *response() const { return GetPointer<const reflection::Object *>(VT_RESPONSE); }
  const ::flatbuffers::Vector<::flatbuffers::Offset<reflection::KeyValue>> *attributes() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<reflection::KeyValue>> *>(VT_ATTRIBUTES);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *documentation() const {
...
struct RPCCallBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) { fbb_.AddOffset(RPCCall::VT_NAME, name); }
  void add_request(::flatbuffers::Offset<reflection::Object> request) { fbb_.AddOffset(RPCCall::VT_REQUEST, request); }
  ...
  explicit RPCCallBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct Service FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *name() const { return GetPointer<const ::flatbuffers::String *>(VT_NAME); }
  bool KeyCompareLessThan(const Service *const o) const { return *name() < *o->name(); }
  int KeyCompareWithValue(const char *_name) const { return strcmp(name()->c_str(), _name); }
...
struct ServiceBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) { fbb_.AddOffset(Service::VT_NAME, name); }
  ...
  explicit ServiceBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct SchemaFile FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_FILENAME = 4, VT_INCLUDED_FILENAMES = 6 };
  /// Filename, relative to project root.
  const ::flatbuffers::String *filename() const { return GetPointer<const ::flatbuffers::String *>(VT_FILENAME); }
  bool KeyCompareLessThan(const SchemaFile *const o) const { return *filename() < *o->filename(); }
  int KeyCompareWithValue(const char *_filename) const { return strcmp(filename()->c_str(), _filename); }
...
struct SchemaFileBuilder {
  ...
  explicit SchemaFileBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct Schema FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const reflection::Object *root_table() const { return GetPointer<const reflection::Object *>(VT_ROOT_TABLE); }
...
struct SchemaBuilder {
  ...
  explicit SchemaBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
