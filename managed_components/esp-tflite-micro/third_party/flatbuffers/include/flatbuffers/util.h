...
inline char CharToUpper(char c) { return static_cast<char>(::toupper(static_cast<unsigned char>(c))); }
...
template<> inline std::string NumToString<signed char>(signed char t) { return NumToString(static_cast<int>(t)); }
template<> inline std::string NumToString<unsigned char>(unsigned char t) { return NumToString(static_cast<int>(t)); }
template<> inline std::string NumToString<char>(char t) { return NumToString(static_cast<int>(t)); }
...
template<> inline bool StringToNumber<int64_t>(const char *str, int64_t *val) { return StringToIntegerImpl(val, str); }
...
template<> inline bool StringToNumber(const char *s, float *val) { return StringToFloatImpl(val, s); }

template<> inline bool StringToNumber(const char *s, double *val) { return StringToFloatImpl(val, s); }
...
inline bool StringIsFlatbufferNan(const std::string &s) { return s == "nan" || s == "+nan" || s == "-nan"; }

inline bool StringIsFlatbufferPositiveInfinity(const std::string &s) {
  return s == "inf" || s == "+inf" || s == "infinity" || s == "+infinity";
}

inline bool StringIsFlatbufferNegativeInfinity(const std::string &s) { return s == "-inf" || s == "-infinity"; }
