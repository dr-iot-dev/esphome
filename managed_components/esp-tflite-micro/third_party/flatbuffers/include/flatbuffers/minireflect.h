...
struct ToStringVisitor : public IterationVisitor {
  ...
  void String(const struct String *str) { EscapeString(str->c_str(), str->size(), &s, true, false); }
...
inline std::string FlatBufferToString(const uint8_t *buffer, const TypeTable *type_table, bool multi_line = false,
                                      bool vector_delimited = true, const std::string &indent = "") {
  ToStringVisitor tostring_visitor(multi_line ? "\n" : " ", false, indent, vector_delimited);
