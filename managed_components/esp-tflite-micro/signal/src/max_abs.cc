...
static inline ae_p24x2s MaxAbs16Single(ae_p24x2s max, ae_p24x2s current) { return AE_MAXABSSP24S(max, current); }
...
#if XCHAL_HAVE_HIFI_MINI || XCHAL_HAVE_HIFI2 || XCHAL_HAVE_HIFI_EP || XCHAL_HAVE_HIFI3
