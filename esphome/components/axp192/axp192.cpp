...
void AXP192Component::Write1Byte(uint8_t Addr, uint8_t Data) { this->write_byte(Addr, Data); }
...
void AXP192Component::ReadBuff(uint8_t Addr, uint8_t Size, uint8_t *Buff) { this->read_bytes(Addr, Buff, Size); }
...
uint8_t AXP192Component::GetBatData() { return Read8bit(0x75); }
...
void AXP192Component::PowerOff() { Write1Byte(0x32, Read8bit(0x32) | 0x80); }

void AXP192Component::SetAdcState(bool state) { Write1Byte(0x82, state ? 0xff : 0x00); }
