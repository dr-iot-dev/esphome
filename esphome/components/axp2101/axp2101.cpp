...
void setFlag(void) { pmu_flag = true; }
...
uint8_t AXP2101Component::GetBatData() { return Read8bit(0x75); }
...
void AXP2101Component::PowerOff() { Write1Byte(0x32, Read8bit(0x32) | 0x80); }

void AXP2101Component::SetAdcState(bool state) { Write1Byte(0x82, state ? 0xff : 0x00); }
